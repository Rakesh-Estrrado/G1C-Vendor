...
class AddService extends StatelessWidget {
  ...
  static Widget builder(BuildContext context, ServiceBloc serviceBloc) {
    return BlocProvider(
        create: (context) =>
            AddServiceBloc(context, serviceBloc)..getCategories(),
        child: AddService());
  }
                        ...
                        return CommonDropDown(
                          ...
                          onSelected: (val) {
                            var catId = state.categoryList
                                .firstWhere((e) => e.categoryName == val)
                                .categoryId;
                            var catName = state.categoryList
                                .firstWhere((e) => e.categoryName == val)
                                .categoryName;
                            addServiceBloc..getServiceCategories(catId);
                            addServiceBloc..updateSelectCatId(catId, catName);
                          },
                        );
                      },
                    ),
                        ...
                        if (subCategories.isNotEmpty) {
                          addServiceBloc
                            ..updateSelectServiceId(
                                ...
                                state.subcategories.first.subcategoryName);
                        }
                    ...
                    BlocSelector<AddServiceBloc, AddServiceState, String?>(
                      ...
                      builder: (context, totalHours) {
                        return CommonTextField(
                            ...
                            onChanged: (val) =>
                                addServiceBloc.addValues(val, "totalHours"));
                      },
                    ),
                    SizedBox(height: 20),
                    BlocSelector<AddServiceBloc, AddServiceState, String?>(
                            ...
                            builder: (context, state) {
                              ...
                              return InkWell(
                                onTap: () => showDatePickerDialog(
                                  initialDate: state.startDate.toString(),
                        ...
                        Expanded(
                          child: BlocBuilder<AddServiceBloc, AddServiceState>(
                            ...
                            builder: (context, state) {
                              ...
                              return InkWell(
                                onTap: () => showDatePickerDialog(
                                  initialDate: state.endDate.toString(),
                                  showPreviousDates: false,
                                  isEndDate: true,
                                  endDate: state.startDate.toString(),
                                  context,
                                  (pickedDate) {
                                    addServiceBloc.addValues(
                                        pickedDate, "endDate");
                    ...
                    BlocBuilder<AddServiceBloc, AddServiceState>(
                      builder: (context, state) {
                        ...
                        if (state.addOnListData.isNotEmpty) {
                          selectedAddOnId = state.addOnListData.first.id;
                          selectedAddOnName = state.addOnListData.first.name;
                        }
