...
import 'package:sizer/sizer.dart';
  ...
  class OTPVerificationLoginScreen extends StatelessWidget {
    final phone;
    final countryCode;
    OTPVerificationLoginScreen({super.key, required this.phone,required  this.countryCode});

    static Widget builder(BuildContext context, String phone, String countryCode) {
      return BlocProvider<LoginBloc>(
        create: (context) => LoginBloc(context),
        child: OTPVerificationLoginScreen(phone: phone,countryCode: countryCode),
      );
    }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CommonButton(label: "Verify", onTap: () {
                      ...
                      myFocusNode.unfocus();
                      context.read<LoginBloc>()..verifyOTP(phone, countryCode, otp);
